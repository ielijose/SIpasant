        ...
        <ul class="sidebar-nav">
            ...
            {{--<li>
                <a href="#"><i class="glyph-icon flaticon-shopping80"></i><span class="sidebar-text">Productos</span>
                    <span class="fa arrow"></span><span class="label label-danger pull-right m-r-20 w-300">New</span>
                </a>
                <ul class="submenu collapse">
                    <li>
                        <a href="/enterprise/products">
                    ...
                    <li>
                        <a href="ecommerce_invoice.html"><span class="sidebar-text">Invoice</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="widgets.html"><i class="glyph-icon flaticon-widgets"></i><span class="sidebar-text">Widgets</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="#">
                    <i class="glyph-icon flaticon-star105"></i><span class="sidebar-text">Extra</span>
                    <span class="fa arrow"></span><span class="label label-danger pull-right m-r-20 w-300">Hot</span>
                </a>
                <ul class="submenu collapse">
                    <li>
            ...
            <li>
                <a href="#">
                    <i class="fa fa-pencil"></i><span class="sidebar-text">Colors Options</span>
            ...
            <li class="active current hasSub">
                <a href="#"><i class="glyph-icon flaticon-pages"></i><span class="sidebar-text">Pages</span><span class="fa arrow"></span>
                    <span class="badge badge-primary pull-right m-r-20">11</span>
                </a>
                <ul class="submenu collapse">
                    <li>
                    ...
                    <li>
                        <a href="forum.html"><span class="sidebar-text">Forum</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="invoice.html"><span class="sidebar-text">Invoice</span></a>
                    </li>
                    <li>
                    ...
                    <li class="current">
                        <a href=""><span class="sidebar-text">Blank Page</span></a>
                    </li>
                </ul>
            </li>
            <li>
