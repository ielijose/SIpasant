...
-- Volcando datos para la tabla sipasant.empresas: ~39 rows (aproximadamente)
...
INSERT INTO `empresas` (`id`, `empresa`, `direccion`, `telefono`, `correo`, `pasantia_id`, `created_at`, `updated_at`) VALUES
	...
	(38, 'PDVSA', 'c', '4551451', 'asf', 41, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(39, 'cabimas noseq', 'asfasfasf', '45111', 'asfas@asf.ca', 42, '2014-07-17 00:48:12', '2014-07-17 00:48:12');
...
-- Volcando datos para la tabla sipasant.estudiantes: ~38 rows (aproximadamente)
...
INSERT INTO `estudiantes` (`id`, `nombre`, `apellido`, `ci`, `carnet`, `direccion`, `telefono_movil`, `telefono_hogar`, `usuario_id`, `created_at`, `updated_at`) VALUES
	...
	(38, 'Isaias ', 'Taborda', '21382657', '65651', 'Cabimas', '16151', '5161', 104, '2014-07-17 00:48:11', '2014-07-17 00:48:11');
/*!40000 ALTER TABLE `estudiantes` ENABLE KEYS */;


-- Volcando estructura para tabla sipasant.eventos
CREATE TABLE IF NOT EXISTS `eventos` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `eventos_semestre_id_foreign` (`semestre_id`),
  CONSTRAINT `eventos_semestre_id_foreign` FOREIGN KEY (`semestre_id`) REFERENCES `semestre` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Volcando datos para la tabla sipasant.eventos: ~1 rows (aproximadamente)
DELETE FROM `eventos`;
/*!40000 ALTER TABLE `eventos` DISABLE KEYS */;
INSERT INTO `eventos` (`id`, `title`, `start`, `className`, `semestre_id`, `created_at`, `updated_at`) VALUES
	(1, 'Prueba', '2014-07-16 16:34:12', 'bg-red', 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- Volcando datos para la tabla sipasant.migrations: ~7 rows (aproximadamente)
...
INSERT INTO `migrations` (`migration`, `batch`) VALUES
	...
	('2014_07_16_162527_create_eventos_table', 2);
...
CREATE TABLE IF NOT EXISTS `pasantias` (
  ...
  `director_departamento` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `semestre` int(11) unsigned NOT NULL,
...
-- Volcando datos para la tabla sipasant.pasantias: ~39 rows (aproximadamente)
DELETE FROM `pasantias`;
/*!40000 ALTER TABLE `pasantias` DISABLE KEYS */;
INSERT INTO `pasantias` (`id`, `actividad`, `supervisor_nombre`, `supervisor_cargo`, `departamento`, `fecha_inicio`, `fecha_fin`, `tipo`, `horario`, `descripcion`, `director_departamento`, `semestre`, `estado`, `estudiante_id`, `created_at`, `updated_at`) VALUES
	...
	(41, 'pw', 'Jefferson Huerta', 'Economista', '2', '2014-07-15', '2014-07-30', 'medio_tiempo', '8', 'dw', '0', 2, 'aprobado', 37, '0000-00-00 00:00:00', '2014-07-16 23:26:00'),
	(42, 'Programacion Web ', 'Luis Padrón', 'Diseñador', 'Diseño y Programación', '2014-07-17', '2014-08-27', 'tiempo_completo', '8:00 am a 5:00pm', 'Desarrollo web', 'Jefferson Huerta', 3, 'aceptado', 38, '2014-07-17 00:48:11', '2014-07-17 00:50:04');
...
-- Volcando datos para la tabla sipasant.procesos: ~17 rows (aproximadamente)
...
INSERT INTO `procesos` (`id`, `aprobacion`, `entrega_carta`, `entrega_borrador`, `retiro_borrador`, `entrega_final`, `pasantia_id`, `created_at`, `updated_at`) VALUES
	...
	(30, '2014-07-15 00:40:58', '2014-07-16 01:27:11', '2014-07-16 01:05:20', '2014-07-16 22:42:44', '2014-07-16 23:10:28', 2, '2014-07-16 01:26:22', '2014-07-16 23:10:28'),
	...
	(43, '2014-07-16 14:53:52', '2014-07-16 22:56:51', '2014-07-16 22:58:02', '2014-07-16 23:00:07', '2014-07-16 23:00:11', 41, '2014-07-16 14:53:52', '2014-07-16 23:00:11'),
	(44, '2014-07-16 23:26:48', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 32, '2014-07-16 23:26:48', '2014-07-16 23:26:48'),
	(45, '2014-07-17 00:50:04', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 42, '2014-07-17 00:50:04', '2014-07-17 00:50:04');
...
-- Volcando datos para la tabla sipasant.semestre: ~3 rows (aproximadamente)
DELETE FROM `semestre`;
/*!40000 ALTER TABLE `semestre` DISABLE KEYS */;
INSERT INTO `semestre` (`id`, `semestre`, `descripcion`, `activo`, `created_at`, `updated_at`) VALUES
	(1, 'I-2013', 'Primero 2014', 0, '0000-00-00 00:00:00', '2014-07-16 14:53:36'),
	(2, 'II-2013', 'Segundo 2013', 0, '0000-00-00 00:00:00', '2014-07-16 23:17:41'),
	(3, 'U-2014', 'Unico 2014', 1, '0000-00-00 00:00:00', '2014-07-16 23:17:41');
...
-- Volcando datos para la tabla sipasant.usuarios: ~104 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `usuario`, `password`, `correo`, `tipo`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(104, 'Isaias ', 'Taborda', 'isaias', '$2y$10$4cTEvS3EJIQFGqoNVGggn.V5PG/R8PTXeDKfIqH0eIBp8ivxVG1me', 'isaias@as.co', 'estudiante', NULL, '2014-07-17 00:11:46', '2014-07-17 00:11:46');
